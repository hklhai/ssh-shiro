...
public class SessionController {
    ...
    @RequestMapping(value = "/saveSe", method = RequestMethod.POST)
    public ModelAndView saveSe(HttpServletRequest request, HttpServletResponse response) {
        ...
        map.put("name", site);
        return new ModelAndView("session/index", map);
    }


    @RequestMapping(value = "/getSe", method = RequestMethod.POST)
    public ModelAndView getSe(HttpServletRequest request) {
        Map<String, String> map = new HashMap<>();
...
//        System.out.println("Session get success");
        ...
        map.put("name", site);
        map.put("user",s);
        return new ModelAndView("session/index2", map);
    }
