      ...
      function getoptions(){
    	  ...
    	  option= {
                  ...
                  legend: {
                      orient:'vertical',
                      x:'left',
                      data: ['出版社-示范','出版社-参与','发行-示范','发行-参与']  ,
                  	 selected:{
                          '出版社-示范':true,
                          '出版社-参与':true,
                          '发行-示范':true,
...

          {
              ...
              normal: { label: { show:true },color:'#ff8c66' },// for legend

              emphasis: { label: { show:true} }

          },

              data: [ ${issuedemonstration}
